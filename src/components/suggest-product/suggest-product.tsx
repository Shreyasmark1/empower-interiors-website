...
function SuggestProduct({ className }: SuggestProductProps) {
  return (
    <section className={cn("max-w-7xl", className)}>
      <div className="mx-auto flex w-[94%] max-w-[1280px] flex-col items-center gap-4 py-14 text-center md:w-[90%] lg:py-16">
        ...
        <Link
          href="/consultation"
          className="mt-2 flex h-12 items-center justify-center rounded-lg bg-primary px-10 text-white shadow-[0_10px_30px_rgba(87,0,84,0.28)] transition-all duration-200 hover:bg-brand-hover"
        >
