...
export default function CategoryListingError({ error, reset }: ErrorProps) {
  React.useEffect(() => {
    toast.error("Couldn't load this collection. Please try again.")
    console.error(error)
  }, [error])
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 px-6 text-center">
      ...
      <p className="max-w-[28rem] leading-relaxed text-muted-foreground">
        We hit a snag while loading this collection. Your wishlist and basket are
        safe.
      </p>
