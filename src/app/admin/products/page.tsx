...
async function fetchProducts(): Promise<ProductRow[]> {
  const data = await listItems<ProductRow>("/products", { limit: "100" });
  return data.items;
}
...
export default function ProductsPage() {
  ...
  const columns: LegacyColumnDef<ProductRow, unknown>[] = [
    ...
    },
    {
      ...
      header: "Min. price",
      cell: ({ getValue }) => formatPrice(getValue() as number | null),
    },
    {
    ...
    <div className="grid gap-6">
      ...
      {!error && (
        <DataTable
          columns={columns}
          data={products}
          emptyState={loading ? "Loading…" : "No products yet."}
        />
      )}
